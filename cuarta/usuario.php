...
<div class="container-fluid bg-primary text-white">
	<div class="container"><h5>BIENVENIDO: <?=$_SESSION["Usuario"];?></h5></div>
</div>
  ...
  <table id="tabla" class="table table-bordered table-hover table-responsive table-fixed">
    <thead>
      <tr style="width:1000px;">
        <th style="width:45px"><center>N°</center></th>
		<th style="width: 400px"><center>Nombre</center></th>
		<th style="width: 250px"><center>Usuario</center></th>
		<th style="width: 250px"><center>Grupo</center></th>
        <th colspan="2" style="width: 150px"><center>Acciones</center></th>
	...
	?>
		<tr style="width:1000px;">
			<td style="width:45px;"><center><?=$i?></center></td><!-- esto es igual a <?php// echo $fila[$i];?>-->
			<td style="width:400px;"><?=$fila[1]?></td>
			<td style="width:250px;"><center><?=$fila[2]?></center></td>
			<td style="width:250px;"><center><?=$fila[5]?></center></td>
			<td style="width:75px;"><center><button type="button" id="btnEditar" name="btnEditar"  class="btn-info btn-sm waves-effect" data-toggle="modal" data-target="#myModal" onClick="editar('<?=$fila[0]?>','<?=$fila[1]?>','<?=$fila[2]?>','<?=$fila[3]?>','<?=$fila[4]?>','<?=$fila[6]?>','<?=$fila[7]?>')"> <i class="material-icons md-18"> create </i> <b ></b></button></center> </td>
			<td style="width:75px;"><center><button type="button" id="btnEliminar" name="btnEliminar"  class="btn-danger btn-sm waves-effect" data-toggle="modal" data-target="#eliminar"  onClick="eliminar('<?=$fila[0]?>')"> <i class="material-icons md-18"> delete </i> <b > </b></button> </center></td>
				...
				<div class="col-xs-4">
					<p>
						<b>ID</b> <input type="text" 
									  ...
									  id="txtID" 
									  required=""
									  class="form-control input-md text-bold"
									  readonly="">
					</p>
				</div>
				</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form id=frmEliminar action="<?php echo htmlspecialchars('eliminar.php');?>" method="post" >
          <h3><center>¿Desea eliminar este registro?.</center></h3>
